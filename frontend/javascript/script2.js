const mySosmed = {
    'facebook': 'https://www.facebook.com/100025862943751',
    'instagram':'https://www.instagram.com/mr.ali.koja.jutt',
    'whatsapp': 'https://api.whatsapp.com/send/?phone=+923218638257&text=Assalamualaikum&type=phone_number&app_absent=0',
    'twitter':  '',
    'discord':  '',
    'linkedin': '',
}
...
function contactMeAt(sosmed) {
    ...
    else console.log('Link is not available for this social media.');
}
